...
patch -Z -d $X_DISTRO_BASE/mpfr-3.1.5 -p1 < mpfr.patch
...
--prefix=$X_DISTRO_BASE/dest/x86_64-w64-mingw32 --with-sysroot=$X_DISTRO_BASE/dest/x86_64-w64-mingw32 --enable-wildcard \
...
# --prefix=$X_DISTRO_BASE/dest       : I want the compiler to be installed here.
# --with-sysroot=$X_DISTRO_BASE/dest : Ditto. (This one is important!)
